...
import com.example.coronadetector.stat.controller.MainActivity;


/**
 * A simple {@link Fragment} subclass.
 */
public class WorldStaticFragment extends Fragment {
Button button;
    ImageView imageView;
    TextView textView;
    Animation animation,animation1,animation2;
    public WorldStaticFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_world_static, container, false);
